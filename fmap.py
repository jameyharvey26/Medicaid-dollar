...
LANES = {
    ...
    "Blocked senior enrollment rule": {
        ...
        # split. QI is a capped federal entitlement: states enroll first-come,
        ...
        # enrollment therefore produces no federal QI savings, because the ceiling
        # binds the spending rather than the enrollment. The pot is the same size
        ...
        #
        # BOUND: if QI were 15% of the lane (its ENROLLMENT share, and a hard upper
        ...
        # for future allotments. Whether that formula is responsive to enrollment is
        # unverified. If allotments rise with prior-year uptake, some QI sensitivity
        # returns over a ten-year window.
        #
        # DO NOT substitute MACPAC's 53/32/15 MSP split here. That is ENROLLMENT.
